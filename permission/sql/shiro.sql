...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `FK_orders_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
insert  into `users`(`id`,`username`,`birthday`,`sex`,`address`) values (1,'王五',NULL,'2',NULL),(10,'张三','1999-07-10','1','北京市'),(16,'张小明',NULL,'1','江西南昌'),(22,'陈小明',NULL,'1','江西南昌'),(24,'张三丰',NULL,'1','江西南昌'),(25,'陈小明',NULL,'1','江西南昌'),(26,'王五',NULL,NULL,NULL);
